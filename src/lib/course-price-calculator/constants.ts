...
export const LAUNCH_CTA_COPY = {
  ...
  body: "You know what your course is worth. Lumon Launch is the done-for-you build that gets it live in two weeks — course site, platform setup, payments, email automation and AI-avatar lesson videos included. Flat fee from $1,500. Bring the expertise; we bring the launch.",
