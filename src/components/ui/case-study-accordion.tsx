      ...
      {items.map((item) => {
        ...
        return (
          <Link
            ...
            className="group block border-t border-white/15 text-white transition-colors duration-500 hover:bg-[#3d7cc9] focus-visible:bg-[#3d7cc9] focus-visible:outline-none motion-reduce:transition-none"
          >
            <Container>
              <div className="grid grid-cols-1 gap-5 py-8 md:grid-cols-3 md:gap-10 md:py-10">
                ...
                <div className="font-mono text-xs leading-6 tracking-wide text-white/85 uppercase">
